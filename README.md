...
其余 19 个 Skill 路线图见 [docs/出海技能集规划.md](docs/出海技能集规划.md#四skill-集合架构21-个-skill-分两期上线)。
...
| **W2-3** | 🚧 接入已有素材：b2b-research（✅ done）/ buyer-finder / market-report / industrial-design |
